...
**3. Requirements:**
   ...
   *3.1 Functional:* The required packages should be installed first and run first cicero_monocle3.R script followed by steamer.py to get a cell-by-TE matrix.

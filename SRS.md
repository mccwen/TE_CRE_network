...
Purpose:* The objecitve of this tool is to streamline the quantification of TE involvement in open chromatins.
   
**2. Overall Description:**
   
   *2.1 Scope: * This tool takes one fragment text file (e.g., file.tsv.gz) which can contain one sample's or multiple samples' fragments and one TE consesus annotaiton file as input. Users should select a species-specific TE consensus annotation file. For both input files, the following minimum information should be included: chromoson, start and end positons
